...
export const useAppStore = defineStore('app', {
  ...
  actions: {
    setTopNav(v) { this.themeOpts.topnav = v },
    setNavigation(v) { this.themeOpts.navigation = v },
    setSystemBar(v) { this.themeOpts.systemBar = v },
    setLoginOverlay(v) { this.loginOverlay = v },
